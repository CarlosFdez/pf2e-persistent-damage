...
declare abstract class DocumentCollection<TDocument extends foundry.abstract.Document> extends Collection<TDocument> {
     ...
     */
    _preCreateDocuments(result: TDocument['data']['_source'][], options: DocumentModificationContext, userId: string): void;
    /**
     ...
     * @param userId    The ID of the User who triggered the operation
     */
    _onCreateDocuments(documents: TDocument[], result: TDocument['data']['_source'][], options: DocumentModificationContext, userId: string): void;
    /**
     ...
     * @param userId  The ID of the User who triggered the operation
     */
    _preUpdateDocuments(result: TDocument['data']['_source'][], options: DocumentModificationContext, userId: string): void;
    /**
     ...
     * @param userId    The ID of the User who triggered the operation
     */
    _onUpdateDocuments(documents: TDocument[], result: TDocument['data']['_source'][], options: DocumentModificationContext, userId: string): void;
    /**
     ...
     * @param userId  The ID of the User who triggered the operation
     */
    _preDeleteDocuments(result: TDocument['data']['_source'][], options: DocumentModificationContext, userId: string): void;
    /**
     ...
     * @param userId    The ID of the User who triggered the operation
     */
    _onDeleteDocuments(documents: TDocument[], result: TDocument['data']['_source'][], options: DocumentModificationContext, userId: string): void;
}
